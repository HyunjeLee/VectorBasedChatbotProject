...
<img width="763" height="545" alt="스크린샷 2025-11-15 오전 11 07 04" src="https://github.com/user-attachments/assets/d40c9fc7-b27f-4857-af99-682f014c6e07" />


## 프로젝트 개요

이 프로젝트는 **Qdrant 벡터 데이터베이스**와 **한국어 임베딩 모델**을 활용하여 사용자 질문과 주어진 데이터 간의 의미적 유사도 분석을 통해 보다 정확한 답변을 제공하는 검색 기반 챗봇입니다. LLM을 사용하지 않고 순수 벡터 유사도 검색만으로 동작하며, Gemini API를 통한 번역 기능으로 다국어 지원 및 검색 정확도를 향상시킵니다.
